...
public class JavaModelVisitor {
    ...
    public void visit(Comment a) {
        if (a == null) {
            ...
            visit((BlockComment) a);
        } else if (a instanceof LineComment) {
            visit((LineComment) a);
        } else {
            throw new RuntimeException("Unknown type: " + a.getClass());
        }
    ...
    public void visit(ElementValueArrayInitializerExpression a) {
        ...
        o = a.getValues();
        if (o != null) {
            for (ElementValue l : (List<ElementValue>) o) {
                visit((ElementValue) l);
            }
        }
    }
    ...
    public void visit(Expression a) {
        ...
        } else if (a instanceof ElementValueArrayInitializerExpression) {
            visit((ElementValueArrayInitializerExpression) a);
    ...
    public void visit(IdentifierExpression a) {
        if (a == null) {
            return;
        }
        Object o = null;
    ...
    public void visit(JavaModel a) {
        if (a == null) {
            ...
            visit((VoidType) a);
        } else if (a instanceof TryWithResourcesStatement) {
            visit((TryWithResourcesStatement) a);
        } else if (a instanceof AndOperatorExpression) {
            visit((AndOperatorExpression) a);
        } else if (a instanceof SignedExpression) {
            visit((SignedExpression) a);
    ...
    public void visit(Object a) {
        if (a == null) {
            ...
            visit((LiteralExpressionType) a);
        } else if (a instanceof JavaModel) {
            visit((JavaModel) a);
        } else if (a instanceof EnumDeclaration) {
            visit((EnumDeclaration) a);
        } else if (a instanceof ImportDeclaration) {
    ...
    public void visit(ScopedExpression a) {
        if (a == null) {
            return;
        } else if (a instanceof FieldAccessExpression) {
            visit((FieldAccessExpression) a);
    ...
    public void visit(Serializable a) {
        if (a == null) {
            return;
        } else if (a instanceof JavaModel) {
            visit((JavaModel) a);
    ...
    public void visit(StatementExpression a) {
        if (a == null) {
            return;
        } else if (a instanceof MethodInvocationExpression) {
            visit((MethodInvocationExpression) a);
    ...
    public void visit(TryWithResourcesStatement a) {
        if (a == null) {
            return;
        }
        Object o = null;
        o = a.getResources();
        if (o != null) {
            for (Resource l : (List<Resource>) o) {
                visit((Resource) l);
            }
        }
        o = a.getTryBlock();
    ...
    public void visit(TypeExpression a) {
        if (a == null) {
            return;
        }
        Object o = null;
