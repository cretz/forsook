...
public class AnnotationExpressionParselet<T extends AnnotationExpression> 
    ...
    public static Expression parseElementValue(JavaParselet<?> parselet, Parser parser) {
        ...
        do {
            //spacing
            parselet.parseWhiteSpaceAndComments(parser);
            //value
            value = parseElementValue(parselet, parser);
            if (value != null) {
                values.add(value);
            }
            //spacing
